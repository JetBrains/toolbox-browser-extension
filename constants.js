...
export const SUPPORTED_LANGUAGES = {
  [DEFAULT_LANGUAGE]: ['studio', 'idea'],
  kotlin: ['studio', 'idea'],
  groovy: ['studio', 'idea'],
  scala: ['studio', 'idea'],
  javascript: ['studio', 'idea', 'phpstorm', 'webstorm'],
  coffeescript: ['studio', 'idea', 'phpstorm', 'webstorm'],
  typescript: ['studio', 'idea', 'phpstorm', 'webstorm'],
  dart: ['studio', 'idea', 'phpstorm', 'webstorm'],
  go: ['studio', 'goland', 'idea'],
  css: ['studio', 'idea', 'phpstorm', 'webstorm'],
  html: ['studio', 'idea', 'phpstorm', 'webstorm'],
  python: ['studio', 'idea', 'pycharm'],
  php: ['studio', 'idea', 'phpstorm'],
  'c#': ['studio', 'rider'],
  'f#': ['rider'],
  'c++': ['studio', 'clion'],
  c: ['studio', 'clion'],
  ruby: ['studio', 'idea', 'rubymine'],
  rust: ['studio', 'clion', 'idea'],
  puppet: ['studio', 'idea', 'rubymine'],
  'objective-c': ['appcode'],
  swift: ['appcode']
};
